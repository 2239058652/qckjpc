  ...
  <div class="pageContainer">
    ...
    <div class="mainContainer">
      <div class="bottomFullWidthFlowContainer">
        <div class="bottomCenterFlowContent" style="width: 100%; height: 100%">
          <timeLineDemo />
          <!-- <div class="cellContentContainer" style="width: 100%; height: 48%">
          </div> -->
        </div>
      </div>
      <div class="leftFlowContainer" style="width: 30%"> </div>
      <div class="rightFlowContainer" style="width: 30%"> </div>
    </div>
  </div>
</template>
...
<script>
  ...
  import timeLineDemo from './../../demos/treeChartDemo.vue';
  // import timeLineDemo from './../../demos/timeLineDemo2.vue';
