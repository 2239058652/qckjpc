<template>
  <dv-border-box-11 title="水环境工作开展动态" class="datav-border-box-content">
  ...
  export default {
    ...
    setup() {
      ...
      const config = {
        header: ['分类', '标题', '时间', '资料'],
        data: [
        ['<span style="color:#00fffc;">重点工程</span>', '元谋县鸡冠山小（一）型水库工程项目', '2022-10-1', 'xh'],
          ['<span style="color:#00fffc;">重点工程</span>', '元谋县河尾水库清淤增效工程项目', '2022-10-14'],
          ['<span style="color:#00fffc;">重点工程</span>', '平田、物茂灌区 8.6 万亩灌溉工程项目', '2022-10-28'],
          ['<span style="color:#00fffc;">重点工程</span>', '元谋县农村供水保障专项行动项目', '2022-10-29', 'fp'],
          ['<span style="color:#00fffc;">重点工程</span>', '元谋县姜驿乡提水工程项目', '2022-11-6'],
          ['<span style="color:#00fffc;">重点工程</span>', '姜驿中型灌区续建配套与节水改造项目', '2022-11-10'],
          ['<span style="color:#00fffc;">重点工程</span>', '元谋县沙地小河山洪沟治理工程项目', '2022-11-18', 'sh'],
          ['<span style="color:#00fffc;">重点工程</span>', '元谋县小型水库维修养护及除险加固项目', '2022-11-25'],
          ['<span style="color:#00fffc;">重点工程</span>', '元谋县农村饮水安全工程维修养护和农村水价综合改革项目', '2022-12-3'],
          ['<span style="color:#00fffc;">重点工程</span>', '元谋县虎溪小（一）型水库工程项目', '2022-12-9'],
          ['<span style="color:#00fffc;">重点工程</span>', '元谋大型灌区“十四五”续建配套与现代化改造项目', '2022-12-24', 'wc'],
          ['<span style="color:#00ff18;">通知</span>', '2023年2月24日水务局通知', '2022-12-26', '--'],
          ['<span style="color:#fff000;">公示</span>', '2022年度水务局公示', '2023-1-1', '--'],
          ['<span style="color:#ffc600;">督查检查</span>', '河长制工作移动巡查检查工作', '2023-1-12'],
