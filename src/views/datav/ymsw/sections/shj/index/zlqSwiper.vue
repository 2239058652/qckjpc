<template>
  <dv-border-box-11 title="治理前" class="datav-border-box-content">
    <div class="datav-border-box-content-container" style="position: relative;width: 100%; height: 95%;">
      ...
      >
          <swiper-slide
            ><img
              src="../../../../../../../assets/images/swiper/shj/before/1.jpg"
              style="width: 100%;"
              mode="widthFix"
          /></swiper-slide>
          <swiper-slide
            ><img
              src="../../../../../../../assets/images/swiper/shj/before/2.jpg"
              style="width: 100%;"
              mode="widthFix"
          /></swiper-slide>
          <swiper-slide
            ><img
              src="../../../../../../../assets/images/swiper/shj/before/3.jpg"
              style="width: 100%;"
              mode="widthFix"
          /></swiper-slide>
          <swiper-slide
            ><img
              src="../../../../../../../assets/images/swiper/shj/before/4.jpg"
              style="width: 100%;"
              mode="widthFix"
          /></swiper-slide>
          <swiper-slide
            ><img
              src="../../../../../../../assets/images/swiper/shj/before/5.jpg"
              style="width: 100%;"
              mode="widthFix"
          /></swiper-slide>
          <swiper-slide
            ><img
              src="../../../../../../../assets/images/swiper/shj/before/6.jpg"
              style="width: 100%;"
              mode="widthFix"
          /></swiper-slide>
          <swiper-slide
            ><img
              src="../../../../../../../assets/images/swiper/shj/before/7.jpg"
              style="width: 100%;"
              mode="widthFix"
          /></swiper-slide>
          <swiper-slide
            ><img
              src="../../../../../../../assets/images/swiper/shj/before/8.jpg"
              style="width: 100%;"
              mode="widthFix"
          /></swiper-slide>
          <swiper-slide
            ><img
              src="../../../../../../../assets/images/swiper/shj/before/9.jpg"
              style="width: 100%;"
              mode="widthFix"
          /></swiper-slide>
          <swiper-slide
            ><img
              src="../../../../../../../assets/images/swiper/shj/before/10.jpg"
              style="width: 100%;"
              mode="widthFix"
          /></swiper-slide>
        </swiper>
...
<script lang="ts" setup>
  ...
  const swiperImageTexts = [
    ...
    '龙川江黄瓜园镇龙山段四乱问题-整改前',
    '龙川江小月旧垃圾池-整改前',
    '勐冈河平田乡华竹金刚钻大桥段乱建问题-整改前',
    '勐冈河平田乡华竹金钢纂大桥段四乱问题-整改前',
    '勐冈河五福村段四乱问题-整改前',
    '牛街干河乱堆垃圾问题-整改前',
    '羊街中坝上坝村四乱问题-整改前'
  ];
