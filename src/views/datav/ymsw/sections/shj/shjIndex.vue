  ...
  <div class="pageContainer">
    <div class="topContainer">
      ...
      <div class="menuContainer">
        ...
        >
        <dv-decoration-7 style="width: 6rem; height: 2rem" @click="setShowModuleIndex(5)"
          >水环境</dv-decoration-7
        >
    ...
    <div class="mainContainer">
      <div class="bottomFullWidthFlowContainer">
        <div class="bottomCenterFlowContent" style="width: 48%">
          ...
          <div class="cellContentContainer" style="width: 100%; height: 40%"> <gzdt /></div>
        </div>
      </div>
      ...
      <div class="rightFlowContainer" style="width: 25%">
        <div class="cellContentContainer" style="width: 100%; height: 35%"> <zlqSwiper /></div>
...
<script>
  ...
  import hkzxc from './index/hkzxc.vue';
  import szzxjc from './index/szzxjc.vue';
  import spzxjc from './index/spzxjc.vue';
  import zlcgSwiper from './index/zlcgSwiper.vue';
  import gzdt from './index/gzdt.vue';
  import zlqSwiper from './index/zlqSwiper.vue';
  import zlgzSwiper from './index/zlgzSwiper.vue';
  import cxyysztb from './index/cxyysztb.vue';

  export default {
    name: 'shjIndex',
    components: { hkzxc, szzxjc, spzxjc, zlcgSwiper, gzdt, zlqSwiper, zlgzSwiper, cxyysztb },
    setup() {
      //控制显示的模块
