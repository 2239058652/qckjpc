  ...
  <div class="pageContainer">
    ...
    <div class="mainContainer">
      <div class="bottomFullWidthFlowContainer">
        <div class="bottomCenterFlowContent" style="width: 100%">
          <div class="cellContentContainer" style="width: 100%; height: 50%;display: flex; flex-direction: row;
    flex-wrap: nowrap;">
            <div class="cellContentContainer" style="width: 25%; height: 100%">
              <fzjz />
          </div>
            <div class="cellContentContainer" style="width: 25%; height: 100%">
              <hzz />
...
<script>
  ...
  import ncgsbz from './index/ncgsbz.vue';
  import nygsbz from './index/nygsbz.vue';
  import szzf from './index/szzf.vue';
  import fzjz from './index/fzjz.vue';
  import hzz from './index/hzz.vue';
  import snjb from './index/snjb.vue';
  import jsyx from './index/jsyx.vue';
  import lsfl from './index/lsfl.vue';

  export default {
    name: 'deptIndex',
    components: { ncgsbz, nygsbz, szzf, fzjz, hzz, snjb, jsyx, lsfl },
    setup() {
      //控制显示的模块
