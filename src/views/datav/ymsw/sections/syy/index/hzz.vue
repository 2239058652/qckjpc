<template>
  <dv-border-box-11 title="空间均衡" class="datav-border-box-content">
   
<div class="datav-border-box-content-container">
      <div style="width: 100%;height: 100%;">
        <img
            src="../../../../../../../assets/images/swiper/syy/2.png"
            style="width: 100%;height: 100%;"
            mode="widthFix"
            v-on:click="onNoticeItemClick1"
        />
      </div>
    </div>
  </dv-border-box-11>
...
<script lang="ts">
  ...
  export default {
    ...
    setup() {
      ...
      const onNoticeItemClick1 = (e) => {
        console.log('onNoticeItemClick1');

        pdfIndexKey.value = 1;
            previewPdfUrl.value = 'assets/kj.pdf';
            pdfPreviewModalVisible.value = true;
            console.log('previewPdf.value=' + previewPdfUrl.value);
      };
      return { pdfPreviewModalVisible, pdfIndexKey, previewPdfUrl, onNoticeItemClick1 };
    },
  };
</script>
<style lang="less">
