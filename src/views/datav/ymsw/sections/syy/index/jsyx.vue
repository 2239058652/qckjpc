<template>
  <dv-border-box-11 title="系统治理" class="datav-border-box-content">
    
<div class="datav-border-box-content-container">
      <div style="width: 100%;height: 100%;">
        <img
            src="../../../../../../../assets/images/swiper/syy/3.png"
            style="width: 100%;height: 100%;"
            mode="widthFix"
            v-on:click="onNoticeItemClick2"
        />
      </div>
    </div>
  </dv-border-box-11>
...
<script lang="ts">
  ...
  export default {
    ...
    setup() {
      ...
      const onNoticeItemClick2 = (e) => {
        console.log('onNoticeItemClick2');

        pdfIndexKey.value = 1;
            previewPdfUrl.value = 'assets/xt.pdf';
            pdfPreviewModalVisible.value = true;
            console.log('previewPdf.value=' + previewPdfUrl.value);
      };
      return { pdfPreviewModalVisible, pdfIndexKey, previewPdfUrl, onNoticeItemClick2 };
    },
  };
</script>
<style lang="less">
