<template>
  <dv-border-box-11 title="党建图展" class="datav-border-box-content">
    <div class="datav-border-box-content-container" style="position: relative;width: 100%; height: 95%;">
      ...
      >
          <swiper-slide
            ><img
              src="../../../../../../../assets/images/swiper/dj/1.jpg"
              style="width: 100%;"
              mode="widthFix"
          /></swiper-slide>
          <swiper-slide
            ><img
              src="../../../../../../../assets/images/swiper/dj/2.jpg"
              style="width: 100%;"
              mode="widthFix"
          /></swiper-slide>
          <swiper-slide
            ><img
              src="../../../../../../../assets/images/swiper/dj/3.jpg"
              style="width: 100%;"
              mode="widthFix"
          /></swiper-slide>
          <swiper-slide
            ><img
              src="../../../../../../../assets/images/swiper/dj/4.jpg"
              style="width: 100%;"
              mode="widthFix"
          /></swiper-slide>
          <swiper-slide
            ><img
              src="../../../../../../../assets/images/swiper/dj/5.jpg"
              style="width: 100%;"
              mode="widthFix"
          /></swiper-slide>
          <swiper-slide
            ><img
              src="../../../../../../../assets/images/swiper/dj/6.jpg"
              style="width: 100%;"
              mode="widthFix"
          /></swiper-slide>
          <swiper-slide
            ><img
              src="../../../../../../../assets/images/swiper/dj/7.jpg"
              style="width: 100%;"
              mode="widthFix"
          /></swiper-slide>
          <swiper-slide
            ><img
              src="../../../../../../../assets/images/swiper/dj/8.jpg"
              style="width: 100%;"
              mode="widthFix"
          /></swiper-slide>
        </swiper>
...
<script lang="ts" setup>
  ...
  const swiperImageTexts = [
    '姜驿乡贡茶村委会主题党日活动暨村级河长清河行动',
    '凉山乡开展“党建+河湖革命”河长清河专项行动',
    '平田乡开展“党建+河湖革命”清河行动专项行动',
    '县乡村振兴局党支部“主题党日”集中学习',
    '县乡村振兴局党组2022年第二期警示教育大会',
    '新华乡开展“主题党日”暨清河行动',
    '元谋县统计局开展“党建+河（湖）长制”清河专项行动',
    '元谋县卫生健康局组织开展“党建+河（湖）长制”文明实践活动'
  ];
