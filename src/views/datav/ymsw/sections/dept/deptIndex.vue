  ...
  <div class="pageContainer">
    <div class="topContainer">
      ...
      <div class="menuContainer">
        ...
        >
        <dv-decoration-7 style="width: 6rem; height: 2rem" @click="setShowModuleIndex(6)"
          >水应用</dv-decoration-7
        >
    ...
    <div class="mainContainer">
      <div class="bottomFullWidthFlowContainer">
        <div class="bottomCenterFlowContent" style="width: 38%">
          ...
          <div class="cellContentContainer" style="width: 100%; height: 32%"> <zzts /></div>
        </div>
      </div>
      ...
      <div class="rightFlowContainer" style="width: 30%">
        <div class="cellContentContainer" style="width: 100%; height: 22%"> <xcdd /></div>
        <div class="cellContentContainer" style="width: 100%; height: 25%">
          <xxsk />
        </div>
        <div class="cellContentContainer" style="width: 100%; height: 25%">
          <yjyl />
        </div>
        <div class="cellContentContainer" style="width: 100%; height: 23%">
          <gqgl />
        </div>
      </div>
    </div>
...
<script>
  ...
  import gqgl from './index/gqgl.vue';
  import hzz from './index/hzz.vue';
  import ncgs from './index/ncgs.vue';
  import nygs from './index/nygs.vue';
  import shyj from './index/shyj.vue';
  import szzf from './index/szzf.vue';
  import xcdd from './index/xcdd.vue';
  import xxsk from './index/xxsk.vue';
  import yjyl from './index/yjyl.vue';
  import zzts from './index/zzts.vue';

  export default {
    name: 'deptIndex',
    components: { gqgl, hzz, ncgs, nygs, shyj, szzf, xcdd, xxsk, yjyl, zzts },
    setup() {
      //控制显示的模块
