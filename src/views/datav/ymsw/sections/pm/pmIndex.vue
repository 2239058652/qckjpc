  ...
  <div class="pageContainer">
    <div class="topContainer">
      ...
      <div class="menuContainer">
        ...
        >
        <dv-decoration-7 style="width: 6rem; height: 2rem" @click="setShowModuleIndex(8)"
          >工程项目</dv-decoration-7
        ><img
    ...
    <div class="mainContainer">
      <div class="bottomFullWidthFlowContainer">
        <div class="bottomCenterFlowContent" style="width: 48%">
          <div class="cellContentContainer" style="width: 100%; height: 45%">
            <plan />
          </div>
          <div class="cellContentContainer" style="width: 100%; height: 51%"> <band /></div>
        </div>
      </div>
      ...
      <div class="rightFlowContainer" style="width: 25%">
        <div class="cellContentContainer" style="width: 100%; height: 26%">
          <other />
        </div>
        <div class="cellContentContainer" style="width: 100%; height: 35%"> <cgSwiper /></div>
        <div class="cellContentContainer" style="width: 100%; height: 35%">
          <glgf />
        </div>
      </div>
    </div>
...
<script>
  ...
  import jxzSwiper from './index/jxzSwiper.vue';
  import zdxm from './index/zdxm.vue';
  import band from './index/band.vue';
  import plan from './index/plan.vue';
  import swgl from './index/swgl.vue';
  import other from './index/other.vue';
  import cgSwiper from './index/cgSwiper.vue';
  import glgf from './index/glgf.vue';

  export default {
    name: 'pmIndex',
    components: { jxzSwiper, zdxm, band, swgl, plan, other, cgSwiper, glgf },
    setup() {
      //控制显示的模块
