    ...
    <div class="mainContainer">
      <div class="bottomFullWidthFlowContainer">
        <div class="bottomCenterFlowContent" style="width: 48%">
          ...
          <div class="cellContentContainer" style="width: 100%; height: 40%"><plan /></div>
        </div>
      </div>
      ...
      <div class="rightFlowContainer" style="width: 25%">
        ...
        <div class="cellContentContainer" style="width: 100%; height: 32%"> <lnxmtb2 /></div>
        <div class="cellContentContainer" style="width: 100%; height: 32%">
          <glgf />
        </div>
      </div>
...
<script>
  ...
  import zcwj from './index/zcwj.vue';
  import mbrw from './index/mbrw.vue';
  import xmjd from './index/xmjd.vue';
  import cgSwiper from './index/cgSwiper.vue';
  import lnxmtb1 from './index/lnxmtb1.vue';
  import lnxmtb2 from './index/lnxmtb2.vue';
  import plan from './index/plan.vue';
  import glgf from './index/glgf.vue';

  export default {
    name: 'pmIndex',
    components: { zcwj, mbrw, xmjd, cgSwiper, lnxmtb1, lnxmtb2, plan, glgf },
    setup() {
      //控制显示的模块
