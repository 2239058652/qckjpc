...
<script setup lang="ts">
  ...
  onUpdated(() => {
    // console.log('pdfDemo.vue onUpdated source=' + state.source);
  });
  onMounted(() => {
    console.log('pdfDemo.vue onMounted source=' + state.source);
    //使用pdfjsLib获取文件信息
    ...
    //   console.log('pdfDemo.vue onMounted promise.then numPages=' + pdf.numPages);
    //   state.numPages = pdf.numPages;
    // });
    if (state.source && Object.keys(state.source).length > 0) {
